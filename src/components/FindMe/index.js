  ...
  render() {
    return (
      ...
      <div>
          ...
          <a href="https://www.instagram.com/zoecohen/"><img src={require("../../assets/png/instagram.png")} /></a>
        </div>

        <div>
          Share me here:
          <FacebookShareButton url={url} quote="YourGirlCodes" hashtag="YourGirlCodes">
            <FacebookIcon round size={"64px"}/>
          </FacebookShareButton>
